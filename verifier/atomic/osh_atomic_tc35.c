...
#if defined HAVE_DECL_SHMEM_INT_ATOMIC_FOR && HAVE_DECL_SHMEM_INT_ATOMIC_FOR
...
#define FUNC_VALUE  shmem_int_atomic_for
 ...
 ***************************************************************************/
int osh_atomic_tc35(const TE_NODE *node, int argc, const char *argv[])
{
#if TEST_ENABLED
    int rc = TC_PASS;
