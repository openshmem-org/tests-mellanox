...
#if defined HAVE_DECL_SHMEM_LONGLONG_ATOMIC_FXOR && HAVE_DECL_SHMEM_LONGLONG_ATOMIC_FXOR
...
#define FUNC_VALUE  shmem_longlong_atomic_fxor
 ...
 ***************************************************************************/
int osh_atomic_tc28(const TE_NODE *node, int argc, const char *argv[])
{
#if TEST_ENABLED
    int rc = TC_PASS;
