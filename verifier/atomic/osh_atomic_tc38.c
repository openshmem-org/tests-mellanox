...
#if defined HAVE_DECL_SHMEM_INT_ATOMIC_OR && HAVE_DECL_SHMEM_INT_ATOMIC_OR
...
#define FUNC_VALUE  shmem_int_atomic_or
 ...
 ***************************************************************************/
int osh_atomic_tc38(const TE_NODE *node, int argc, const char *argv[])
{
#if TEST_ENABLED
    int rc = TC_PASS;
