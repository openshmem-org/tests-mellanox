...
#if defined HAVE_DECL_SHMEM_LONG_ATOMIC_OR && HAVE_DECL_SHMEM_LONG_ATOMIC_OR
...
#define FUNC_VALUE  shmem_long_atomic_or
 ...
 ***************************************************************************/
int osh_atomic_tc39(const TE_NODE *node, int argc, const char *argv[])
{
#if TEST_ENABLED
    int rc = TC_PASS;
