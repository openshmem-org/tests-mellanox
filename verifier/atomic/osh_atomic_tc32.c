...
#if defined HAVE_DECL_SHMEM_INT_ATOMIC_AND && HAVE_DECL_SHMEM_INT_ATOMIC_AND
...
#define FUNC_VALUE  shmem_int_atomic_and
 ...
 ***************************************************************************/
int osh_atomic_tc32(const TE_NODE *node, int argc, const char *argv[])
{
#if TEST_ENABLED
    int rc = TC_PASS;
