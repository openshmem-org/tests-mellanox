...
#if defined HAVE_DECL_SHMEM_LONGLONG_ATOMIC_FOR && HAVE_DECL_SHMEM_LONGLONG_ATOMIC_FOR
...
#define FUNC_VALUE  shmem_longlong_atomic_for
 ...
 ***************************************************************************/
int osh_atomic_tc37(const TE_NODE *node, int argc, const char *argv[])
{
#if TEST_ENABLED
    int rc = TC_PASS;
