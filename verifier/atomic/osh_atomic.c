...
const TE_NODE atomic_tcs[] =
{
    ...
    { NULL, osh_atomic_tc23, "int_xor",             aopt_set_string( "tc23" ), 	"shmem_uint_atomic_xor(): A simple test.",              TEST_INT_XOR},
    { NULL, osh_atomic_tc24, "long_xor",            aopt_set_string( "tc24" ), 	"shmem_ulong_atomic_xor(): A simple test.",             TEST_LONG_XOR},
    { NULL, osh_atomic_tc25, "longlong_xor",        aopt_set_string( "tc25" ), 	"shmem_ulonglong_atomic_xor(): A simple test.",         TEST_LONGLONG_XOR},
    { NULL, osh_atomic_tc26, "int_fetch_xor",       aopt_set_string( "tc26" ), 	"shmem_uint_atomic_fetch_xor(): A simple test.",        TEST_INT_FETCH_XOR},
    { NULL, osh_atomic_tc27, "long_fetch_xor",      aopt_set_string( "tc27" ), 	"shmem_ulong_atomic_fetch_xor(): A simple test.",       TEST_LONG_FETCH_XOR},
    { NULL, osh_atomic_tc28, "longlong_fetch_xor",  aopt_set_string( "tc28" ), 	"shmem_ulonglong_atomic_fetch_xor(): A simple test.",   TEST_LONGLONG_FETCH_XOR},
    { NULL, osh_atomic_tc29, "int_fetch_and",       aopt_set_string( "tc29" ), 	"shmem_uint_atomic_fetch_and(): A simple test.",        TEST_INT_FETCH_AND},
    { NULL, osh_atomic_tc30, "long_fetch_and",      aopt_set_string( "tc30" ), 	"shmem_ulong_atomic_fetch_and(): A simple test.",       TEST_LONG_FETCH_AND},
    { NULL, osh_atomic_tc31, "longlong_fetch_and",  aopt_set_string( "tc31" ), 	"shmem_ulonglong_atomic_fetch_and(): A simple test.",   TEST_LONGLONG_FETCH_AND},
    { NULL, osh_atomic_tc32, "int_and",             aopt_set_string( "tc32" ), 	"shmem_uint_atomic_and(): A simple test.",              TEST_INT_AND},
    { NULL, osh_atomic_tc33, "long_and",            aopt_set_string( "tc33" ), 	"shmem_ulong_atomic_and(): A simple test.",             TEST_LONG_AND},
    { NULL, osh_atomic_tc34, "longlong_and",        aopt_set_string( "tc34" ), 	"shmem_ulonglong_atomic_and(): A simple test.",         TEST_LONGLONG_AND},
    { NULL, osh_atomic_tc35, "int_fetch_or",        aopt_set_string( "tc35" ), 	"shmem_uint_atomic_fetch_or(): A simple test.",         TEST_INT_FETCH_OR},
    { NULL, osh_atomic_tc36, "long_fetch_or",       aopt_set_string( "tc36" ), 	"shmem_ulong_atomic_fetch_or(): A simple test.",        TEST_LONG_FETCH_OR},
    { NULL, osh_atomic_tc37, "longlong_fetch_or",   aopt_set_string( "tc37" ), 	"shmem_ulonglong_atomic_fetch_or(): A simple test.",    TEST_LONGLONG_FETCH_OR},
    { NULL, osh_atomic_tc38, "int_or",              aopt_set_string( "tc38" ), 	"shmem_uint_atomic_or(): A simple test.",               TEST_INT_OR},
    { NULL, osh_atomic_tc39, "long_or",             aopt_set_string( "tc39" ), 	"shmem_ulong_atomic_or(): A simple test.",              TEST_LONG_OR},
    { NULL, osh_atomic_tc40, "longlong_or",         aopt_set_string( "tc40" ), 	"shmem_ulonglong_atomic_or(): A simple test.",          TEST_LONGLONG_OR},
