...
#if defined HAVE_DECL_SHMEM_LONG_ATOMIC_FAND && HAVE_DECL_SHMEM_LONG_ATOMIC_FAND
...
#define FUNC_VALUE  shmem_long_atomic_fand
 ...
 ***************************************************************************/
int osh_atomic_tc30(const TE_NODE *node, int argc, const char *argv[])
{
#if TEST_ENABLED
    int rc = TC_PASS;
